    	...
    	<div class="span8 project_items">
            	<div class="row-fluid">
        			<div class="project_image">
   	    				<img src="../images/portfolio/itw_1.jpg" alt="ITW">
        			</div>
            	</div>
               	<div class="row-fluid">
        			<div class="project_image">
   	    				<img src="../images/portfolio/itw_2.jpg" alt="ITW">
        			</div>
            	</div>
                <div class="row-fluid">
        			<div class="project_image">
   	    				<img src="../images/portfolio/itw_3.jpg" alt="ITW">
        			</div>
            	</div>
                	<div class="row-fluid">
        			<div class="project_image">
   	    				<img src="../images/portfolio/itw_4.jpg" alt="ITW">
        			</div>
            	</div>                  
   	  ...
   	  <div class="span4">
      		<div class="project_name">
            	<h2 class="text-left">ITW</h2>
            </div>
      		<div class="project_description">
            <p class="project_description">ITW wanted a landing page that would introduce several of their most important food equipment brands. This design highlights the different aspects of each brand while maintaining a cohesive identity.</p>
          </div>
  	  </div>
<div class="clear"></div>       
    </article>
