...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		<div class="wrap">
			...
			<hgroup>
				<h1 class="site-title"><a href="http://www.cocomocreative.com/about.php" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></h1>
				<h2 class="site-description"><a href="http://www.cocomocreative.com/portfolio/index.php"><?php bloginfo( 'description' ); ?></a></h2>
			</hgroup>
		</div><!-- .wrap -->
