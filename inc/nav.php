  ...
  <nav class="navbar navbar-inverse">
    <div class="navbar-inner">
      <div class="container-fluid">
        <div class="navwrapper"> <a class="brand" href="index.php"><img src="images/cocomo_creative.png" width="197" height="17" alt="Cocomo Creative" /></a>
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="nav_portfolio <?php if ($section == "The Work") { echo "active"; } ?>"><a href="portfolio/index.php">THE WORK</a> </li>
              <li class="nav_resume <?php if ($section == "The Creds") { echo "active"; } ?>"><a href="docs/resume.pdf" target="_blank">THE CREDS</a> </li>
